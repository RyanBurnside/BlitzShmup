#include "GameObject.bmx.console.release.linux.x64.h"
...
void __m_GameObject_GameObject_New(struct _m_GameObject_GameObject_obj* o) {
	...
	o->__m_gameobject_gameobject_mover = (struct _m_GameObject_Mover_obj*)((struct _m_GameObject_Mover_obj*)&bbNullObject);
	o->__m_gameobject_gameobject_dead = 0;
	o->__m_gameobject_gameobject_hitbox = (struct _m_GameObject_Hitbox_obj*)((struct _m_GameObject_Hitbox_obj*)&bbNullObject);
}
...
BBFLOAT __m_GameObject_GameObject_getX(struct _m_GameObject_GameObject_obj* o){
	(o->__m_gameobject_gameobject_mover )->clas->m_getX((struct _m_GameObject_Mover_obj*)o->__m_gameobject_gameobject_mover );
	return .00000000f;
}
BBFLOAT __m_GameObject_GameObject_getY(struct _m_GameObject_GameObject_obj* o){
	(o->__m_gameobject_gameobject_mover )->clas->m_getY((struct _m_GameObject_Mover_obj*)o->__m_gameobject_gameobject_mover );
	return .00000000f;
}
